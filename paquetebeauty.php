  ...
  <header class="header-area">
    ...
    <main>
        ...
        <div class="breadcrumb-area bg-default pt-185 pb-180 has-breadcrumb-overlay"
            data-background="assets/img/bg/aparatobg.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-xxl-12">
                        <div class="sg-breadcrumb-wrap text-center">
                            <h3 class="sg-breadcrumb-title">Beauty Party</h3>
                ...
                <div class="row g-0">
                    <div class="col-xxl-6 col-xxl-6 col-lg-6">
                        <div class="sg-about-left-img-3">
                            <img src="assets/img/about/post.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-xxl-6 col-xxl-6 col-lg-6">
                        <div class="sg-about-right-box has-about-space-1 pl-100">
                            <div class="sg-section-title-wrap">
                                <span class="sg-section-subtitle">Que contiene</span>
                                <h3 class="sg-section-title  mb-25">Beauty Party</h3>
                                  <input type="hidden" id="preciofinal2" name="preciofinal2" value="2750.00">
                                             <input type="hidden" id="id_subcategoria" name="id_subcategoria" value="44">
                                             <?php 
                                               echo "
                                                 <input type=\"hidden\" id=\"id_session\" name=\"id_session\" value=".$_SESSION['ida'].">
                                                 ";
                                                 ?>
                                             <input type="hidden" id="id_medico" name="id_medico" value="13">
                                <input type="hidden" id="Valoracion" name="Valoracion" value="500.00">
                                 <input type="hidden" id="quantity" name="quantity" value="1">
                                   
                            </div>
                            <div class="sg-about-content-right mb-45">
                                <p>Disfruta de nuestra Beauty Party en Sannia Clinic en donde podras elegir el tipo de Hydrafacial que deseas realizarte, aprovecha esta super promocíón y dejate consentir</p>
                            </div>
                           
                            <h4 class="sg-section-title">Aparta con $ 500.00 pesos</h4>
                            <div class="sg-about-author-box pb-35">
                                <div class="col-xxl-12">

                                        <a name="but_submit" id="but_submit" idEspe="44" class="agregacarritomanual sg-single-product-popup-buy-now-btn" type="button">   Apartar tu Lugar   </a>

                                    </div>
                                <div class="sg-about-author-img">
                                    <!-- <img src="assets/img/user/user-1.png" alt="">
                                </div>
                                <div class="sg-about-author-content">
                                    <h4 class="sg-about-author-title"><a href="doctor-details.html">Hasoon Jeemy</a> </h4>
                                    <span class="sg-about-author-subtitle">Breast Specialist </span>
                                </div> -->
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xxl-5 col-xl-5 col-md-5 col-lg-12 col-sm-5 mb-20 mb-sm-0">
                                        <div class="sg-about-play-text-right sg-has-about-play-space-3">
                                            <a href="https://www.youtube.com/watch?v=TFwFMav_cpE" class="popup-video sg-about-play-text-bordered-btn">
                                                <div class="sg-icon">
                                    ...
                                    <div class="col-xxl-7 col-xl-7 col-md-7 col-sm-7 col-lg-12">
                                        <div class="sg-about-successfully-solved-box-3">
                                            <h3 class="title">3k</h3>
                                            <p class="content">Surgery cases
                                                solved successfully</p>
                                        </div>
                                    </div>
                                </div>
                            </div> -->
        ...
        <!-- service area end -->
        <!-- features area start -->
        <!-- <div class="features-area pt-120 pb-125">
            <div class="container">
                <div class="row mb-40">
                    <div class="col-xxl-12">
                        <div class="sg-section-title-wrap text-center">
                            <span class="sg-section-subtitle">Features</span>
                            <h3 class="sg-section-title">Why Choose Us</h3>
                        </div>
                    </div>
                </div>
                <div class="sg-service-tab-content-box-2">
                    <div class="row justify-content-center">
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-9 mb-50 mb-lg-0">
                            <div class="sg-service-tab-controls-2 pr-20">
                                <nav>
                                    <div class="nav" id="nav-tab" role="tablist">
                                        <button class="active" id="nav-tab-tab" data-bs-toggle="tab"
                                            data-bs-target="#nav-tab1" type="button" role="tab" aria-controls="nav-tab"
                                            aria-selected="true"><i class="flaticon flaticon-breast-reconstruction"></i>
                                            <span>Breast Implants</span></button>
                                        <button class="" id="nav-tab2-tab" data-bs-toggle="tab"
                                            data-bs-target="#nav-tab2" type="button" role="tab" aria-controls="nav-tab"
                                            aria-selected="false"><i class="flaticon flaticon-liposuction"></i>
                                            <span>Liposuction</span></button>
                                        <button class="" id="nav-tab3-tab" data-bs-toggle="tab"
                                            data-bs-target="#nav-tab3" type="button" role="tab" aria-controls="nav-tab"
                                            aria-selected="false"><i class="flaticon flaticon-lip"></i>
                                            <span>Intervention</span></button>
                                        <button class="" id="nav-tab4-tab" data-bs-toggle="tab"
                                            data-bs-target="#nav-tab4" type="button" role="tab" aria-controls="nav-tab"
                                            aria-selected="false"><i class="flaticon flaticon-botox"></i>
                                            <span>Skin Surgery</span></button>
                                        <button class="" id="nav-tab5-tab" data-bs-toggle="tab"
                                            data-bs-target="#nav-tab5" type="button" role="tab" aria-controls="nav-tab"
                                            aria-selected="false"><i class="flaticon flaticon-liposuction"></i>
                                            <span>Breast Implants</span></button>
                                    </div>
                                </nav>
                        ...
                        <div class="col-xxl-8 col-xl-8 col-lg-8">
                            <div class="tab-content pl-10" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-tab1" role="tabpanel">
                                    <div class="sg-service-tab-content-2" data-bg-color="#F6F6F6">
                                        <div class="sg-service-tab-content-img-2">
                                            <img src="assets/img/service/service-2-1.jpg" alt="">
                                            <a href="https://www.youtube.com/watch?v=TFwFMav_cpE" class="popup-video sg-service-tab-content-icon-3 has-service-tab-play-pos-3">
                                               <i class="fas fa-play"></i> 
                                            </a>
                                        </div>
                                        <div class="sg-service-tab-content-wrap-2 sh-has-service-content-space-1">
                                            <h4 class="sg-service-tab-content-title-2"><a href="service-details.html">Facts that you know
                                                    breast implant</a></h4>
                                            <p class="sg-service-tab-content-text-2">
                                                Breast implantation many women over world retain their youth
                                            </p>
                                            <div class="sg-service-tab-content-price-2 mb-40">
                                                From <span>$670</span>
                                            </div>
                                            <a href="appointment.html" class="sg-service-appoint-btn-2">Appointment</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="nav-tab2" role="tabpanel">
                                    <div class="sg-service-tab-content-2" data-bg-color="#F6F6F6">
                                        ...
                                        <div class="sg-service-tab-content-wrap-2 sh-has-service-content-space-1">
                                            <h4 class="sg-service-tab-content-title-2"><a href="service-details.html">Prison plastic surgery</a></h4>
                                            <p class="sg-service-tab-content-text-2">
                                                Breast implantation many women over world retain their youth
                                            </p>
                                            <div class="sg-service-tab-content-price-2 mb-40">
                                ...
                                <div class="tab-pane fade" id="nav-tab3" role="tabpanel">
                                    <div class="sg-service-tab-content-2" data-bg-color="#F6F6F6">
                                        ...
                                        <div class="sg-service-tab-content-wrap-2 sh-has-service-content-space-1">
                                            <h4 class="sg-service-tab-content-title-2"><a href="service-details.html">Ethnic plastic surgery</a></h4>
                                            <p class="sg-service-tab-content-text-2">
                                                Breast implantation many women over world retain their youth
                                            </p>
                                            <div class="sg-service-tab-content-price-2 mb-40">
                                ...
                                <div class="tab-pane fade" id="nav-tab4" role="tabpanel">
                                    <div class="sg-service-tab-content-2" data-bg-color="#F6F6F6">
                                        ...
                                        <div class="sg-service-tab-content-wrap-2 sh-has-service-content-space-1">
                                            <h4 class="sg-service-tab-content-title-2"><a href="service-details.html">enhancement of the buttocks </a></h4>
                                            <p class="sg-service-tab-content-text-2">
                                                Breast implantation many women over world retain their youth
                                            </p>
                                            <div class="sg-service-tab-content-price-2 mb-40">
                                ...
                                <div class="tab-pane fade" id="nav-tab5" role="tabpanel">
                                    <div class="sg-service-tab-content-2" data-bg-color="#F6F6F6">
                                        ...
                                        <div class="sg-service-tab-content-wrap-2 sh-has-service-content-space-1">
                                            <h4 class="sg-service-tab-content-title-2"><a href="service-details.html">Facts that you know breast implant</a></h4>
                                            <p class="sg-service-tab-content-text-2">
                                                Breast implantation many women over world retain their youth
                                            </p>
                                            <div class="sg-service-tab-content-price-2 mb-40">
        ...
        <!-- cta area start -->
        <br>
        <div class="cta-area pt-65 pb-65 theme-bg">
            <div class="cta-style-about">
                <div class="container">
                    <div class="sg-cta-box">
                        <div class="row align-items-center">
                            <div class="col-xxl-8 col-xl-8 col-lg-8">
                                 <div class="sg-cta-box-left mb-20 mb-lg-0">
                                     <h4 class="sg-cta-box-title"><bdi class="cta-title d-block">Contáctanos</bdi> 
