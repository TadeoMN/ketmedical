...
<body>
    ...
    <main>
        ...
        <div class="breadcrumb-area bg-default pt-185 pb-180 has-breadcrumb-overlay"
            data-background="assets/img/bg/servicios.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-xxl-12">
                        <div class="sg-breadcrumb-wrap text-center">
                            <h3 class="sg-breadcrumb-title">Servicios</h3>
        ...
        <!-- breadcrumb area end -->
        <!-- service area start -->
        <div class="service-area pt-125 pb-100">
            <div class="container">
                <div class="row">
                    <div class="col-xxl-12">
                        <div class="sg-section-title-wrap pb-30 text-center">
                            <span class="sg-section-subtitle">Servicios</span>
                            <h3 class="sg-section-title  mb-25">Nuestros servicios</h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                     <?php 
                                        ...
                                        $stmt = $conn->prepare("SELECT *  FROM ket_categoria where activo=1 and id not in (11)  ORDER BY RAND() LIMIT 10");
                                                      $stmt->execute();
                                                      $countriesList = $stmt->fetchAll();

                                                      foreach($countriesList as $country){
                                                $fotos= 'assets/img/portfolio/'.$country['img1'];
                        ...
                        <div class=\"col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12\">
                            <div class=\"sg-doctor-grid-box-1-1 mb-30 text-center\">
                                ...
                                <div class=\"sg-doctor-grid-box-content-wrap-1-1\">
                                    ...
                                    <a href=\"case-details.php?iddr=".$country['id']."\" class=\"sg-doctor-grid-box-link-1-1\">Conoce más</a>
                                </div>
                            </div>
                        </div>";
                        }
