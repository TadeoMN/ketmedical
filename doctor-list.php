...
<!-- End Meta Pixel Code -->
                                            ...
                                            <li><a href="index.php">Inicio</a>
                                             ...
                                             <li><a href="doctor-list.php">Doctores</a>
                                                 <ul class="submenu">
                                                     ...
                                                     <li><a href="doctor-list.php">Conoce a nuestros Doctores</a></li>
    ...
    <!-- header area end -->
        <main>
            ...
            <div class="breadcrumb-area bg-default pt-185 pb-180 has-breadcrumb-overlay" data-background="assets/img/bg/cart.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-xxl-12">
                            <div class="sg-breadcrumb-wrap">
                                <h3 class="sg-breadcrumb-title">Nuestros Doctores</h3>
            ...
            <!-- breadcrumb area end -->
            <!-- doctor list area start -->
            <div class="doctor-list-area pt-130 pb-100">
                <div class="container">
                    <div class="sg-doctor-list-filter-1-1 mb-50">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <?php 
                                        ...
                                        $stmt = $conn->prepare("SELECT *  FROM ket_doctores where activo=1 and id not in (11)  ORDER BY RAND() LIMIT 10");
                                                      $stmt->execute();
                        ...
                        <div class=\"col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12\">
                            <div class=\"sg-doctor-grid-box-1-1 mb-30 text-center\">
                                <div class=\"sg-doctor-grid-box-img-1-1\">
                                    <img src='".$fotos."'  alt=\"\">
                                </div>
                                <div class=\"sg-doctor-grid-box-content-wrap-1-1\">
                                    <h4 class=\"sg-doctor-grid-box-title-1-1\"><a href=\"doctor-details.php?iddr=".$country['Id']."\">".$country['Nombre']."</a></h4>
                                    <a href=\"doctor-details.php?iddr=".$country['Id']."\" class=\"sg-doctor-grid-box-subtitle-1-1\">".$country['cabecera']."</a>
                                    ...
                                    <a href=\"doctor-details.php?iddr=".$country['Id']."\" class=\"sg-doctor-grid-box-link-1-1\">Conoce más</a>
                                </div>
                            </div>
                        </div>";
                        }
